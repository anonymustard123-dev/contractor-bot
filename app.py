...
# --- FIXED PDF FUNCTION (NO KEY ERRORS) ---
def create_pdf_report(before_img, after_img, summary_text, shopping_list):
    ...
    # FIX: Use 'CustomTitle' instead of conflicting names
    custom_title = ParagraphStyle('CustomTitle', parent=styles['Heading1'], color=HexColor('#0f172a'), alignment=1, fontSize=24)
    story.append(Paragraph("Renovation Proposal", custom_title))
